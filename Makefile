...
SOURCES = main.cpp system.cpp peashooter.cpp sunflower.cpp wallnut.cpp zombie.cpp# The source files (add more if you have other files)
HEADERS = system.hpp peashooter.hpp global.hpp sunflower.hpp wallnut.hpp zombie.hpp
