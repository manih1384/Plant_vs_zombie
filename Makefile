...
SOURCES = main.cpp system.cpp plants.cpp zombie.cpp projectile.cpp icons.cpp sun.cpp# The source files (add more if you have other files)
HEADERS = system.hpp plants.hpp zombie.hpp projectile.hpp icons.hpp sun.hpp
